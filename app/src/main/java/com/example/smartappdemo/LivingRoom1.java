...
public class LivingRoom1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<DataModel>() {
            ...
            public void onResponse(Call<DataModel> call, Response<DataModel> response) {
                ...
                //To turn lights off according to the api responce
                ...
                //Adjusting Seekbar according to api data
        ...
        //To switch cardview color when switch is pressed
